...
*   🛡️ **Agente Auditor**: Escanea todas las operaciones en busca de errores, duplicados o gastos inusuales, alertándote de inmediato si algo no cuadra.

---

### 3. Primeros Pasos: ¿Cómo empezar?

#### Acceso al Sistema
1.  Entra a la aplicación.
2.  Haz clic en **"Iniciar Sesión con Google"**. Es rápido y seguro.
3.  La primera vez que entres, el sistema configurará tu perfil automáticamente como Administrador.

#### Configura tu Empresa
Antes de empezar, ve a la pestaña **"Configuración"** en el menú lateral:
*   Escribe el **Nombre de tu Empresa**.
*   Ingresa tu **RFC**.
*   Activa o desactiva las funciones de IA según tus preferencias de seguridad.

---

### 4. Uso del Panel General (Dashboard)
Al entrar, verás un resumen visual de la salud financiera:
*   **Ingresos y Egresos**: Totales mensuales actualizados al momento.
*   **Pendientes**: Cuántas transacciones necesitan que les eches un ojo.
*   **Alertas**: Si el Agente Auditor detecta algo extraño, aparecerá aquí en color rojo.
*   **Estado de Agentes**: Un monitor en tiempo real que te indica qué está haciendo cada IA en ese momento.
